...
4. Lee el contexto del corpus antes de analizar:
   - `PROYECTOS/BARTLEBY/corpus/corpus.md` — mapa acumulativo actual
   - `PROYECTOS/BARTLEBY/corpus/analisis/` — análisis previos
...
7. Guarda el análisis en: `PROYECTOS/BARTLEBY/corpus/analisis/[nombre-archivo].analisis.md`

8. Guarda el texto original de la editorial en: `PROYECTOS/BARTLEBY/corpus/editoriales/[nombre-archivo].md`
