...
> **Protocolo transversal:** `mod/instructions/sala-protocolo.instructions.md` aplica siempre.
...
Lee `DRAFTS2/sala/agente-{alias}/estado.md`. Confirma:
...
Lista los ficheros en `DRAFTS2/sala/agente-{alias}/`. El único fichero debe ser `estado.md`.
...
Lee `DRAFTS2/sala/tablero.md`. Busca tu alias en cualquier celda de estado. No debe aparecer en ninguna tarea `en-curso:{alias}` ni `entregada:{alias}` ni `propuesta:{alias}`.
