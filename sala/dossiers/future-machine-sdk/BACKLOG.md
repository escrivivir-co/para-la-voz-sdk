...
| FS-01 | libre | — | FS-00 | `.github/instructions/future-machine-schema.instructions.md` | [TASK-01](./tasks/TASK-01_SCHEMA_Y_SLOTS.md) |
| FS-02 | libre | — | FS-01, PS-05† | `.github/templates/future-machine.template.md` | [TASK-02](./tasks/TASK-02_TEMPLATE_Y_MANIFEST.md) |
...
> † PS-05 es del dossier `lore-db-sdk` — deja el scaffold `lore/` disponible para incluir `FUTURE_MACHINE.md`.
