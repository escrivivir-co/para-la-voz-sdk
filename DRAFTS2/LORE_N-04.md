# `[N-04]` — Noticia escrivivir.co: "Lo que no son habas contadas en el caso de la filmo maldita, según un experto jurista"
...
|-------|-------|
| Marca | `[N-04]` |
| Medio | escrivivir.co — Noticias posicionadas |
| Tipo | Cronica analitica / Periodismo posicionado |
| Fuente primaria | `[S-03]` — Analisis completo de Cristobal (83 min, GPU) |
| Artefacto | [N-04-escrivivir-habas-contadas-experto-jurista.md](N-04-escrivivir-habas-contadas-experto-jurista.md) |
| Estado | Borrador listo para publicacion |

## Contenido — resumen DRY

La noticia **no repite** el material de `[S-03]` sino que lo reorganiza editorialmente. Extrae y estructura los **argumentos propositivos** del analisis juridico de `[P-04]` Cristobal sobre el caso:

### Ejes extraidos

| # | Eje propositivo | Conecta con |
|---|-----------------|-------------|
| 1 | **Dos pilares de la acusacion** (autorizacion + beneficio indirecto) y por que ambos son fragiles | `[T-09]`, `[T-13]` |
| 2 | **Beneficio indirecto desmontable empiricamente**: graficas de crecimiento del acusado no muestran inflexion | `[T-09]` |
| 3 | **Animo (dolo) como eje decisivo**: beneficio puede ser indirecto, pero animo tiene que ser directo y probado. Sin monetizacion, sin promocion cruzada, sin animo | `[T-09]` |
| 4 | **Circular FGE 1/2016 y el ejemplo del portero**: Fiscalia usa ejemplo de portero-camello en discoteca. Cristobal lo desmonta: no hay portero-camello en el caso | `[T-09]`, `[R-09]` |
| 5 | **Contraataque por propiedad industrial**: FlixOle copia el modelo de utilidad de Zoowoman. Via de demanda mercantil del acusado al denunciante | `[P-09]`, `[T-06]` |
...
> "No se reproduce aqui la integridad del debate en directo [...]. Se han extraido y reorganizado los argumentos propositivos preservando su sustancia juridica."

> "La logica del caso llevaria a criminalizar la preservacion cultural como tal."
