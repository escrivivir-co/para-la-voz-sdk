# B. Piezas de redes sociales `[S-*]`

> ← [LORE_INDEX.md](LORE_INDEX.md)

---

## B.1. Piezas de `[P-01]` Feo

| Marca | Pieza | Tipo |
|-------|-------|------|
| `[S-01]` | Video detención | Testimonio directo |
| `[S-02]` | Video post juicio, a espera veredicto | Testimonio directo |
...
- El repost fija una lectura de infraestructura social del caso: sin ruido distribuido, el asunto no entra en radar institucional.
- Se incorpora aquí la reflexión sobre el **efecto Streisand**: la tentativa de disciplinamiento del caso produce amplificación pública.

## B.2. Piezas de `[P-04]` Cristóbal
...
| Marca | Pieza | Tipo |
|-------|-------|------|
| `[S-05]` | Elevar el caso a Bustinduy | Acción mediática → institucional |
