...
```
Agente 1 ──▶ Track ES (extraccion-sala-sdk) — tareas ES-02..ES-05 en feat/sala-sdk
Agente 2 ──▶ Track CU (gap-corto-universo) — tarea CU-01 en mod/legislativa
```

ES-01 ya ejecutada por Aleph (rama creada). ES-06 y ES-07 son merges que ejecuta Aleph manualmente.

---

## Track CU — gap-corto-universo (1 tarea)
...
## Track ES — extraccion-sala-sdk (7 tareas)
...
> **ES-06 y ES-07:** solo Aleph (merge + limpieza).
