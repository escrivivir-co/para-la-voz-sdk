# Universo-1 — Rama R4: Contraataque

> **Naturaleza:** nodos ficticios del universo, no datos reales.
> **Grafo padre:** [LORE_F-02_UNIVERSO.md](../LORE_F-02_UNIVERSO.md)
> **Piezas ancla de lore real:** referenciadas por marca, no duplicadas.
...
| Vía | Base | Uso en R4 | Estado |
|-----|------|-----------|--------|
| Contraataque mercantil-cultural | Cruce de propiedad industrial + competencia desleal | Formula principal de la rama | fijado |
| Investigación de adquisiciones Mercury | ¿Cómo se obtuvieron los derechos sobre miles de títulos? | Sombra narrativa que aumenta coste y sospecha | H2 sigue abierto |
...
La demanda contra Cerezo genera base para solicitar suspensión cautelar del proceso penal mientras se resuelve la cuestión mercantil/civil. X pasa de abr-2026 a ~abr-2027. El espacio nuevo (T+0.5) es el tiempo de maniobra.

**Condición necesaria:** la demanda de R4.1 tiene que ser suficientemente sólida como para que un juez considere la conexión entre ambos procesos.
...
- **Ausencia `[S-11]`:** nadie replica Zoowoman (la web de enlaces). Solo se preserva YouTube.
...
|-------------------|-----------|-------------|
| Crowdfunding amplificado por 2ª cola `[S-06]`…`[S-09]` | Financiación distribuida | `[P-06]` sustrato |
| FACUA como paraguas jurídico | Rubén Sánchez `[P-07]` ya tiene relación con Bravo `[P-02]` | `[T-02]`, `[S-13]` |
| Filmoteca Española como peso institucional | Legitimación estatal del valor cultural | `[N-04]` eje 6, `[S-12]` |
| Tándem legal ciudadano | Replicación de funciones, no de héroes | `[S-13]` |
| Investigación de adquisiciones Mercury | `[?]` Casos en prensa de propietarios que malvenden derechos a Cerezo | Pieza por crear |

**Resolución narrativa v2:** Bravo sostiene el penal; Cristóbal dirige argumentario; Rubén/FACUA hacen de paraguas; Facu mantiene el frente de ruido público e interlocución. La financiación se compacta como mezcla de crowdfunding + peso institucional. No hace falta doctrinalizar más para la rama.
...
- Conserva FlixOlé (no se le quita su negocio).
- Suelta presión sobre títulos sin propiedad efectiva demostrada — el dato duro ya está anclado en `[S-10]`.
- X se resuelve por acuerdo, no por sentencia.
- El sistema evita producir jurisprudencia y protege su propia continuidad: se cierra el caso, no la grieta.
...
- Circulación cultural: ocio + educación, sin pretensión de negocio.
- Estructura legal que `[N-04]` eje 7 describe: asociación, verificación de licencias, interés cultural.
- **Clave `[N-05]`:** el RD 2016 de obras huérfanas sólo habilita a instituciones públicas. La red federada necesita ancla institucional (Filmoteca Española) para ser legal.
- **Clave `[S-11]`:** la infraestructura distribuida ya existe. Lo que falta es formalizar, no construir.
- **Clave `[S-12]`:** la segunda ola ya no trabaja como plaza, sino como unidad persistente de actividad.
- Feo `[S-11]`: lo valioso a 100 años no son las películas sino el registro de ideas.
...
## Huecos y resoluciones v2

| ID | Hueco | Opciones | Estado |
|----|-------|----------|--------|
| H1 | Dato "acusan de X títulos vs Y propios de Cerezo" | **RESUELTO** `[S-10]`: 11.007 reclamadas vs 40 con derechos. Cine iraní, Bután, Uganda, Yugoslavia, URSS | resuelto |
| H2 | Prácticas de adquisición Mercury (propietarios que malvenden) | a) Crear pieza externa / b) Dejarlo como pregunta que nadie contesta | sombra narrativa — no bloquea |
| H3 | Forma jurídica principal del contraataque | Compactada como contraataque mercantil-cultural | resuelto narrativamente |
| H4 | Quién financia la estructura legal | Mezcla crowdfunding + paraguas institucional | resuelto narrativamente |
| H5 | Rol de Bravo en contraofensiva | Bravo sostiene penal; Cristóbal argumentario; Rubén/FACUA paraguas; Facu medios | resuelto narrativamente |
| H6 | Filmoteca Española — cómo entra | RD 2016 como argumento necesario; la vía legal no pasa por otra puerta | resuelto narrativamente |
